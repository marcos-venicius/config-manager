...
syntax keyword c3DataType float double ichar char bool byte short ushort int uint long ulong isz usz iptr uptr int128 uint128 float16 float128 typeid any anyfault
