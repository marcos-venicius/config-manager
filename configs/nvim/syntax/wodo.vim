...
" ----- State -----
syntax match wodoStateKey /^\.state\ze\(\s\|$\)/ nextgroup=wodoStateTodo,wodoStateDoing,wodoStateDone,wodoStateStuck skipwhite
...
syntax keyword wodoStateStuck stuck contained
...
highlight wodoStateStuck guifg=#ff5555
